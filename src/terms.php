...
<body class="container shadow">
  ...
  <main class="container" role="main">
    ...
    <h1 class="text-center font-weight-bolder"> Terms of service </h1>

    <div class="mb-3">
      <strong> This doesn't count for anything.</strong>
      <em class="mb-3 flex-column d-flex">
      ...
      <strong> Go watch Marvel Avengers: Infinity War</strong>
      <em class="mb-3 flex-column d-flex">
      ...
      <strong> Coca-cola wants world domination</strong>
      <em class="mb-3 flex-column d-flex">
      ...
      <strong> The world didn't end in 2012</strong>
      <em class="mb-3 flex-column d-flex">
      ...
      <strong> Let's go out for some drinks</strong>
      <em class="mb-3 flex-column d-flex">
